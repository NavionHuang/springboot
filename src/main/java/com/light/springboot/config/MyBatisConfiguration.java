...
public class MyBatisConfiguration {
	...
	public SqlSessionFactoryBean sqlSessionFactory(DataSource dataSource) {
		...
		Resource[] mapperXml;
		try {
			mapperXml = resolver.getResources("classpath:com/light/springboot/dao/*.xml");
		...
		// 设置别名包
		sqlSessionFactoryBean.setTypeAliasesPackage("com.light.springboot.pojo");
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		mapperScannerConfigurer.setBasePackage("com.light.springboot.dao");
